...
<body
    class="w-full mx-auto h-screen flex flex-col py-10 pb-10 pt-8 bg-[radial-gradient(circle_at_0%_100%,rgba(220,38,38,0.4),transparent_30%),radial-gradient(circle_at_50%_0%,rgba(220,38,38,0.4),transparent_40%),linear-gradient(to_bottom,#020617,#000000)]">
    ...
    <section class="m-auto flex flex-col gap-15 lg:gap-14 md:gap-30 lg:pt-5 pt-10 md:pt-0 mx-8">
        ...
        <form action="{{ route('authenticate') }}" method="POST" class="flex flex-col gap-8 mx-1" autocomplete="off" id="loginForm">
            @csrf
            <div
                class="flex flex-col gap-6 bg-linear-to-r from-gray-500 to-gray-900 rounded-full outline-1 outline-white py-3 md:py-6 lg:py-5 mx-3.5 md:w-100 md:mx-auto">
            ...
            <button type="submit" id="btn_submit"
                class="bg-linear-to-r from-gray-400 to-gray-600 rounded-full text-white font-mono tracking-wide py-3 md:py-6 w-36 md:w-50 lg:py-5 mx-auto shadow-[6px_6px_2px_rgba(59,56,55,1)]">
                Confirm
            </button>
        </form>
