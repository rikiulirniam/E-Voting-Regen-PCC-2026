        ...
        <div class="w-full max-w-md mx-auto mt-10 h-screen flex flex-col justify-center">
            ...
            <form action="{{ route('authenticate') }}" method="POST" class="bg-white shadow-md flex flex-col rounded px-8 pt-6 pb-8 mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="nim" name="nim" value="{{ old('nim') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('nim') border-red-500 @enderror" placeholder="0.00.00.0.00">
                    @error('nim')
