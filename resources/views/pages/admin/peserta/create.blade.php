...
<div class="max-w-2xl mx-auto px-4 py-10">
    ...
    {{-- Petunjuk Format --}}
    <div class="mb-6 bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-xl p-4 sm:p-5">
        <div class="flex flex-col sm:flex-row items-start gap-3 sm:gap-4">
            <svg class="w-5 h-5 text-blue-500 shrink-0 mt-1" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <div class="text-xs sm:text-sm text-blue-800 dark:text-blue-200 w-full">
                ...
                <ul class="list-disc list-inside space-y-1 text-xs sm:text-sm leading-relaxed">
                    ...
                    <li>
                        <strong>status_jabatan</strong>:
                        <code class="bg-blue-100 dark:bg-blue-900 px-1 rounded">anggota aktif</code>
                        atau
                        <code class="bg-blue-100 dark:bg-blue-900 px-1 rounded">STO</code>
                    </li>
        ...
        <div class="mt-4 pt-3 border-t border-blue-200 dark:border-blue-800">
            <a href="{{ route('peserta.template') }}"
                class="inline-flex items-center gap-2 text-xs sm:text-sm font-medium text-blue-700 dark:text-blue-300 hover:underline">
