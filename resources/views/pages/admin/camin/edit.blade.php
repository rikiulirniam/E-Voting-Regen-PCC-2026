...
<head>
    ...
    <title>Edit Calon Admin - Regen 2026</title>
...
<body class="bg-gray-100 dark:bg-gray-900 min-h-screen">
    ...
    <div class="max-w-2xl mx-auto px-4 py-10">
        ...
        <div class="mb-8 flex items-center justify-between">
            <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Edit Calon Admin</h1>
        ...
        {{-- Form --}}
        <form action="{{ route('camin.update', $camin) }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <input type="text" id="name" name="name" value="{{ old('name', $camin->name) }}" required
            ...
            <div>
                ...
                <input type="number" id="no_urut" name="no_urut" value="{{ old('no_urut', $camin->no_urut) }}" min="1" required
            ...
            <div>
                ...
                <textarea id="visi" name="visi" rows="3" required
                          class="w-full px-3 py-2 text-sm border rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 resize-y @error('visi') border-red-500 @else border-gray-300 @enderror">{{ old('visi', $camin->visi) }}</textarea>
            </div>
            ...
            <div>
                ...
                <textarea id="misi" name="misi" rows="4" required
                          class="w-full px-3 py-2 text-sm border rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 resize-y @error('misi') border-red-500 @else border-gray-300 @enderror">{{ old('misi', $camin->misi) }}</textarea>
            </div>

            {{-- Foto --}}
            <div>
                <label for="foto" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                    Foto <span class="text-gray-400 font-normal">(opsional, maks. 2MB — kosongkan jika tidak ingin mengubah)</span>
                </label>
                ...
                <div id="foto-preview-wrapper" class="mt-3 hidden">
                    <p class="text-xs text-gray-500 dark:text-gray-400 mb-1">Preview foto baru:</p>
                    <img id="foto-preview" src="" alt="Preview foto baru" class="h-40 w-40 object-cover rounded-xl border border-gray-200 dark:border-gray-600">
                </div>
            </div>
